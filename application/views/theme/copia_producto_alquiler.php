                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header bg-primary bg-primary">
                            ...
                            <form action="<?php echo site_url('Alquiler/buscar_copia_alquiler/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'');?>" method="POST">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="input-group m-b">
                                            <input type="text"  name="copia" class="form-control" placeholder="nombre del producto">
