	  ...
	  $(function () {
	  	...
	  	$("#plot-chart-one").on("plothover", function (event, pos, item) {
	  		if (item) {
	  ...
	  $(function () {
	  	...
	  	$("#plot-chart-two").on("plothover", function (event, pos, item) {
	  		if (item) {
	  			var x = item.datapoint[0].toFixed(2),
	  				y = item.datapoint[1].toFixed(2);
	  ...
	  $(function () {
	  	...
	  	$("#plot-chart-three").on("plothover", function (event, pos, item) {
	  		if (item) {
	  			var x = item.datapoint[0].toFixed(2),
	  				y = item.datapoint[1].toFixed(2);
	  ...
	  $(function () {
	  	...
	  	$("#plot-chart-four").on("plothover", function (event, pos, item) {
	  		if (item) {
	  			var x = item.datapoint[0].toFixed(2),
	  				y = item.datapoint[1].toFixed(2);
	  ...
	  $(function () {
	  	...
	  	$("#plot-chart-five").on("plothover", function (event, pos, item) {
	  		if (item) {
	  			var x = item.datapoint[0].toFixed(2),
	  				y = item.datapoint[1].toFixed(2);
	  ...
	  $(function () {
	  	...
	  	$("#plot-chart-six").on("plothover", function (event, pos, item) {
	  		if (item) {
	  			var x = item.datapoint[0].toFixed(2),
	  				y = item.datapoint[1].toFixed(2);
	  ...
	  $(document).ready(function () {
	  	$(".ui-player a").on( "click",function (e) {
	  		e.preventDefault();
